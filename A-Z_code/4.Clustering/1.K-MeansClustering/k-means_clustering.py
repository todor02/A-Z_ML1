...
# for i in range(0, 6):
    # plt.scatter(X[y_kmeans == i, 0], X[y_kmeans == i, 1], s=100, c='red', label='Cluster ' + str(i+1))

# Could make something like that, but we need the colors to change, and we cant
# change them with numbers, but only with letters soo a "for cycle" would be actually making a spaghetti code here
